using CoreFramework.CrossCuttingConcerns.Logging;
using CoreFramework.CrossCuttingConcerns.Logging.Serilog;
using MediatR;
using Microsoft.AspNetCore.Http;
using Newtonsoft.Json;

namespace CoreFramework.Application.Pipelines.Logging;
